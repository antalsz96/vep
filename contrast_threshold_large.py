...
fileName = expInfo['observer'] + expInfo['dateStr'] + '_large'
...
stimulus = visual.GratingStim(win, tex='sin', size=15, sf=1, pos=[0,0], units='deg', mask='gauss', maskParams={'sd':4})  # sf: cycles per degree (c/deg)
