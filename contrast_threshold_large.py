...
fileName = f"{expInfo['observer']}_{expInfo['side']}_nagy_{expInfo['dateStr']}"
#fileName = expInfo['observer'] + '_' + expInfo['side'] + expInfo['dateStr'] + '_large'
...
stimulus = visual.GratingStim(win, tex='sin', size=10, sf=1, pos=[0,0], units='deg', mask='gauss', maskParams={'sd':4})  # sf: cycles per degree (c/deg)
